...
int main(int argc, char * argv[])
{
      ...
      std::string filename = "IMU_Regler_logger_std_results.csv";

      std::ofstream fstream;
      {
        fstream.open("IMU_Regler_logger_std_results.csv", std::ios_base::out);
       ...
       auto logger_callback =
         [&i](const std_msgs::msg::UInt64::SharedPtr msg) {
           ...
           std::ofstream fstream;
           fstream.open("IMU_Regler_logger_std_results.csv", std::ios_base::app);
